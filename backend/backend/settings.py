...
# In production, this will be read from environment variable
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-vc$pcj5j4uatk*_5^=y@21r04b+--8ca!-%pwy$f(993$m+gxa')
...
# For Render deployment - trust the proxy headers
